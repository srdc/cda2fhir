...
public interface IDataTypesTransformer {
	...
	*/
	...
	/**
	* Transforms a CDA BIN instance to a FHIR Base64BinaryType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA BL instance to a FHIR BooleanType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA ED instance to a FHIR Attachment composite datatype instance.
	* @param ed A CDA ED instance
	...
	*/
	...
	/**
	* Transforms a CDA II instance to a FHIR Identifier composite datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA INT instance to a FHIR IntegerType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA IVL_TS instance to a FHIR Period composite datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA PIVL_TS instance to a FHIR Timing composite datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA PQ instance to a FHIR SimpleQuantity composite datatype instance.
	* @param pq A CDA PQ instance
	...
	*/
	...
	/**
	* Transforms a CDA REAL instance to a FHIR DecimalType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA ST instance to a FHIR StringType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a String that includes a date in CDA format to a FHIR DateTimeType primitive datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA StrucDocText instance to a FHIR Narrative composite datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA TEL instance to a FHIR ContactPoint composite datatype instance.
	...
	*/
	...
	/**
	* Transforms a CDA TS instance to a FHIR DateTimeType primitive datatype instance.
	* @param ts A CDA TS instance
	* @return A DateTimeType primitive datatype instance
	*/
	...
	/**
	* Transforms a CDA TS instance to a FHIR InstantType primitive datatype instance.
	* @param ts A CDA TS instance
