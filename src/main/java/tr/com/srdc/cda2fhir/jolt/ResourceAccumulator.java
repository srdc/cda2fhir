...
public class ResourceAccumulator implements SpecDriven, ContextualTransform {
	...
	private class MedicationContainer {
		...
		Map<String, Object> medicationResource;

		IdentifierMap<Map<String, Object>> medByOrgId;

		public MedicationContainer(Map<String, Object> medicationResource) {
			this.medicationResource = medicationResource;
		}

		public void putOrg(String system, String value, Map<String, Object> org) {
			if (this.orgIdMap == null) {
				this.orgIdMap = new IdentifierMap<Map<String, Object>>();
			}
			this.orgIdMap.put("Organization", system, value, org);
		}

		public boolean hasOrg(String system, String value) {
			if (this.orgIdMap == null) {
				this.orgIdMap = new IdentifierMap<Map<String, Object>>();
			}
			...
			this.orgIdMap.get("Organization", system, value) != null;
		}
	...
	public ResourceAccumulator(Object spec) {
		...
		public Object transform(Object input, Map<String, Object> context) {
			...
			IdentifierMap<String> refDisplaysByIdentifier = (IdentifierMap<String>) context
					.get("RefDisplaysByIdentifier");
