...
public class CDTest {
    ...
    public void testTemplate() throws Exception {
        List<Object> chainrSpecJSON = JsonUtils.filepathToList("src/test/resources/jolt/data-type/CD.json");
        Chainr chainr = Chainr.fromSpec(chainrSpecJSON);
    	
    	File file = new File("src/test/resources/jolt-verify/data-type/CD.json");
